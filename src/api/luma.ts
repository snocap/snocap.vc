...
export async function fetchUpcomingEvents(id: LumaCalendarId, pageSize = 4): Promise<SimpleLumaEvent[]> {
	const response = await fetch(`https://api.lu.ma/calendar/get-items?calendar_api_id=${id}&period=future&pagination_limit=${pageSize}`, {
		"headers": {
