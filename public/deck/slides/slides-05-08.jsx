...
const SCIENTIFIC_CARDS = [
  {
    ...
    body: (
      <>
        IP-protected chemistries solved a critical bottleneck for solar panels —
        reducing manufacturing costs and increasing longevity.{" "}
        <strong>
          POs totaling over $30M, including the world's largest perovskite
          manufacturer.
        </strong>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        enzymes.{" "}
        <strong>
          Over $10M in contracts with Bayer, Syngenta, and Corteva.
        </strong>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        <strong>
          24 paid pilots including LVMH, Hugo Boss, and H&amp;M, and over $1M in
          revenue.
        </strong>
      </>
    ),
  },
  {
    ...
    body: (
      <>
        ...
        energy-hungry datacenters. The result is a novel chip architecture with
        a{" "}
        <strong>
          proven 40× reduction in energy draw, and a clear path to a 500×
          improvement.
        </strong>
      </>
    ),
    ...
    >
      ...
      >
        <img
          src={logo}
          alt=""
          style={{ height: logoH, width: "auto", maxWidth: 320 }}
        />
        <span
          style={{
            fontFamily: FONT.mono,
    ...
    <SlideFrame page={6} bg={COLORS.snow}>
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(180deg, rgba(245,242,237,0.55) 0%, rgba(245,242,237,0.78) 100%)",
        }}
      />
      ...
      <FundColumn
        ...
        callout={
          <>
            As of {currentQuarterLabel()},{" "}
            <strong>60% of Fund I companies</strong> have markups or are
            currently raising up rounds.
          </>
        }
        calloutDark={false}
      />
      ...
      <FundColumn
        ...
        callout={
          <>
            Fund II will maintain portfolio size while{" "}
            <strong>increasing ownership</strong>. The check-size range ensures
            we can target ownership levels across sectors and markets.
          </>
        }
        calloutDark={true}
      />
...
const FUND_I_ROWS = [
  [
    "RevivBio Inc.",
    "AI-powered enzyme discovery and validation",
    "Oct '23",
    "$135K",
    "$13.3M",
    "1.2x†",
  ...
  [
    "Sparxell Inc.",
    "Biodegradable colors and films",
    "Nov '23",
    "$240K",
    "$15.0M",
    "1.25x",
  ...
  [
    "Sironix Renewables",
    "Cost-competitive sustainable surfactants",
    "Oct '24",
    "$200K",
    "$9.65M",
    "1x",
  ...
  [
    "SoFab Inks Inc.",
    "High-performance electrochemicals",
    "Oct '24",
    "$200K",
    "$6.0M",
    "1x†",
  ...
  [
    "Cool Amps Corp",
    "Industry leading critical mineral recovery",
    "Feb '25",
    "$150K",
    "$7.0M",
    "1x",
  ...
  [
    "GRAIN Ecosystem",
    "Waste-to-energy enablement and reporting",
    "Mar '25",
    "$125K",
    "$8.5M",
    "—",
    "SE Ventures (Schneider Electric), Elevate Ventures",
  ],
  [
    "Bloom Hold Co.",
    "Hardware supply chain as a service",
    "Apr '25",
    "$150K",
    "$12.0M",
    "1x†",
  ...
  [
    ...
    "Feedstock generation from waste biomass",
    "Sep '25",
    "$250K",
    "$10.0M",
    "1x",
  ...
  [
    ...
    "Ultra-low cost organic plastic blends",
    "Feb '26",
    "$250K",
    "$7.0M",
    "1x",
...
function Slide07_FundI() {
  return (
    <SlideFrame page={7} bg={COLORS.snow}>
      ...
      >
        Past performance is provided for illustrative purposes only and is not
        necessarily indicative or a guarantee of future results. There can be no
        guarantee that Fund II will be able to achieve comparable returns or
        avoid losses. There can be no guarantee that any investment
        opportunities will be identified, sourced, or successfully executed by
        the Fund. The availability of such opportunities is subject to market
        conditions and other factors beyond the Fund's control.
      </div>
    </SlideFrame>
  );
}
