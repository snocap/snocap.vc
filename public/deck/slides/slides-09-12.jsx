  ...
  return (
    <SlideFrame page={9} bg={COLORS.snow}>
      ...
      <div style={{
        ...
        fontFamily: FONT.mono, fontSize: 22, letterSpacing: "-0.04em",
        color: COLORS.graphite, textTransform: "uppercase",
      }}>Engineers, operators, capital allocators</div>

      {/* Team cards */}
      <div style={{
        position: "absolute",
        left: 96, top: 280, right: 96,
        display: "grid",
        ...
        {TEAM.map((p) => (
          <div key={p.name} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div style={{
              ...
              fontFamily: FONT.mono, fontSize: 32,
              letterSpacing: "-0.04em", color: COLORS.ink, lineHeight: 1.05,
            }}>
            ...
            <div style={{
              fontFamily: FONT.sans, fontSize: 18, fontStyle: "italic",
              lineHeight: 1.4, color: COLORS.ink, marginTop: -4,
            }}>{p.tagline}</div>
          </div>
        ))}
      </div>
...
const VENTURE_PARTNERS = [
  { src: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/HBS_Shield.svg/200px-HBS_Shield.svg.png", alt: "Harvard Business School", label: "Harvard\nBusiness School" },
  { src: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Wharton_logo.svg/240px-Wharton_logo.svg.png", alt: "Wharton", label: "Wharton" },
];
...
function TextLogo({ children, color = COLORS.ink, size = 32, family = FONT.sans, weight = 600, italic = false }) {
  return (
    <div style={{
      fontFamily: family,
      fontSize: size,
...
function Slide10_WhoWeWorkWith() {
  const Logo = ({ src, alt, h = 56, maxW = "100%" }) => (
    <div style={{ height: h, display: "flex", alignItems: "center", justifyContent: "center", width: "100%" }}>
      <img src={`assets/logos/${src}`} alt={alt} style={{ maxHeight: h, maxWidth: maxW, objectFit: "contain" }} />
    </div>
  );
    ...
    <SlideFrame page={10} bg={COLORS.snow}>
      ...
      <div style={{ position: "absolute", left: 96, top: 240, width: 800 }}>
        <Section title="Venture Partners">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24, padding: "28px 32px", alignItems: "center" }}>
        ...
        <Section title="Fellows">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 16, padding: "24px 24px", alignItems: "center" }}>
        ...
        <Section title="University Relationships">
          <div style={{ display: "flex", flexWrap: "wrap", gap: "20px 24px", padding: "24px 24px", justifyContent: "center", alignItems: "center" }}>
            <div style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}><Logo h={56} alt="Cornell" src="cornell.png" /></div>
            <div style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}><Logo h={56} alt="RIT" src="rit.png" /></div>
            <div style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}><Logo h={56} alt="Cambridge Enterprise" src="cambridge.png" /></div>
            <div style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}><Logo h={48} alt="UC Davis" src="uc-davis.png" /></div>
            <div style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}><Logo h={56} alt="Penn State" src="penn-state.png" /></div>
            <div style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}><Logo h={48} alt="UC Riverside" src="uc-riverside.png" /></div>
          </div>
        </Section>
      </div>
      ...
      <div style={{ position: "absolute", left: 928, top: 240, width: 880 }}>
        <Section title="Co-investors & Pilots">
          <div style={{
            ...
            {[
              { src: "schneider-electric.png", alt: "Schneider Electric", h: 84 },
              ...
              { src: "future-communities-capital.png", alt: "Future Communities Capital", h: 84 },
            ].map((logo) => (
              <div key={logo.src} style={{ flex: "0 0 calc(33.333% - 16px)", display: "flex", justifyContent: "center" }}>
      ...
      <div style={{
        position: "absolute",
        left: 96, right: 96, bottom: 56,
        textAlign: "center",
        fontFamily: FONT.sans, fontSize: 11, lineHeight: 1.4, color: COLORS.graphite,
      }}>
        The logos and names of venture partners, fellows, and university relationships presented herein are for illustrative purposes only to reflect the Fund's broader network and ecosystem.
        The inclusion of such logos does not imply any formal partnership, endorsement, or affiliation, nor does it indicate that any such parties have committed
        capital to, will invest in, or will otherwise be involved in the Fund. These relationships are subject to change and may be informal or non-exclusive.
      </div>
    </SlideFrame>
  );
}
...
function Section({ title, children }) {
  return (
    <div style={{ marginBottom: 24 }}>
      ...
      <div style={{ border: `1px solid ${COLORS.fog}`, background: COLORS.white }}>
        {children}
      </div>
    </div>
  );
  ...
  return (
    <SlideFrame page={11} dark={true} bg={COLORS.black}>
      ...
      <div style={{
        ...
        background: "radial-gradient(ellipse at center, rgba(0,0,0,0) 0%, rgba(0,0,0,0.5) 80%)",
      }} />

      <SlideTitle style={{ color: COLORS.snow }}>Where breakthroughs are happening today</SlideTitle>
      ...
      <div style={{
        ...
        textAlign: "center",
        fontFamily: FONT.sans, fontSize: 11, lineHeight: 1.4,
        color: "rgba(255,255,255,0.6)",
      }}>
        The investment strategy of the Fund is subject to change without any prior notice to investors and there is no guarantee the Fund will achieve its investment objective.
      </div>
    </SlideFrame>
  );
}
  ...
  return (
    <SlideFrame page={12} bg={COLORS.snow}>
      ...
      <div style={{
        ...
        fontFamily: FONT.mono, fontSize: 96,
      ...
      <div style={{
        position: "absolute", left: 480, top: 188,
        fontFamily: FONT.sans, fontSize: 26, fontWeight: 500,
        color: COLORS.ink, lineHeight: 1.3, maxWidth: 1100,
      }}>
        High-performance electrochemical inputs<br />
        for next-gen solar and sensor applications
      </div>

      {/* Grid of journey cards + 2 photos */}
      <CaseStudyGrid stages={[
        { stage: "Discovery", body: "With industry experts highlighting perovskites as the next generation of solar materials, SoFab emerged from our research as the only company addressing key constraints in the emerging category." },
        { stage: "Analysis", body: "Their chemicals unlock record-breaking efficiency and durability in perovskite solar while reducing cost pressures, with process technology adaptable to catalysts and advanced sensors." },
        { stage: "Conviction", body: "Customer validation from leading perovskite developers testing SoFab on record-breaking lines. Reinforced by LOIs & MOUs from global manufacturers, with interest advancing to paid trials & POs." },
        { stage: "Negotiation", body: "Without an existing technical or Silicon Valley seasoned investor on the cap table, we invested under the agreement that we had a board observer role. We invested at a $6M post-money valuation." },
        { stage: "Syndication", body: "Supported strategic pre-seed fundraise decisions and seed round narrative." },
      ]} photoTopRight="assets/case/sofab-top.png" photoBottomLeft="assets/case/sofab-bottom.png" placeholder="lab" />
      ...
      <div style={{
        ...
        The case study presented herein relates solely to an investment made by Fund I and is included for illustrative purposes only.
        This investment may not be representative of the investments of Fund II, and no assurance can be given that Fund II will identify, access, or achieve investments or results comparable to those described herein.
...
function CaseStudyGrid({ stages, photoTopRight, photoBottomLeft, placeholder }) {
  const Arrow = () => (
    <div style={{
      flex: "0 0 auto",
      width: 48,
      ...
      <svg width="48" height="20" viewBox="0 0 48 20" fill="none" stroke={COLORS.orange} strokeWidth="2" strokeDasharray="6 4">
  ...
  return (
    <div style={{
      position: "absolute",
      left: 96, right: 96, top: 320, bottom: 140,
      display: "flex",
      flexDirection: "column",
      gap: 40,
    }}>
      ...
      <div style={{
        ...
        {stages.flatMap((s, i) => i === 0
          ? [cell(s, i)]
          : [<Arrow key={`a${i}`} />, cell(s, i)]
        )}
      </div>
      ...
      <div style={{
        ...
        <div style={{ flex: "0 0 662px", display: "flex" }}>{photo(photoBottomLeft, placeholder)}</div>
        <div style={{ flex: "1 1 auto", display: "flex" }}>{photo(photoTopRight, placeholder)}</div>
      </div>
    </div>
  );
}
