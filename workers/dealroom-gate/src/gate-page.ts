...
<body>
  <div class="card">
    ...
    <div class="subtitle">GP Deal Room</div>
    ${error ? `<div class="error">${error}</div>` : ""}
    <div class="prompt">Enter your email and access code to view the deal room.</div>
    <form method="POST" action="/dealroom">
      ...
      <button type="submit">Enter Deal Room</button>
    </form>
    <div class="fine-print">This deal room contains confidential SNØCAP fund materials. Access is logged and your access code is unique to you — please don't share it.</div>
  </div>
</body>
</html>`;
}
