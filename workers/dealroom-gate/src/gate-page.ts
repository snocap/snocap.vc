...
<head>
  <meta charset="utf-8" />
  <title>SNØCAP Fund 2 Data Room</title>
...
<body>
  <div class="card">
    ...
    <form method="POST" action="/dealroom">
      ...
      <button type="submit">Enter Data Room</button>
    </form>
    <div class="fine-print">This data room contains confidential SNØCAP fund materials. Access is logged and your access code is unique to you. Please don't share it.</div>
  </div>
</body>
</html>`;
}
